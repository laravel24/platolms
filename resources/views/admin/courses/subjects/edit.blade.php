...
@section('content')
    <div class="primary-content" id="page-content">
        <div class="">
            <h2 class="page-header mb30">Update Subject</h2>
        </div>
        ...
        <div class="content-box">          
            ...
            {!! Form::open(['route' => ['admin.subjects.update', $subject->id], 'id' => 'form', 'method' => 'put', 'files' => 'true']) !!}
...
@section('scripts')
    <script>
        const vm = new Vue({
            ...
            data: {
                name: 'Vue.js',
                subjectName: '<?php echo $subject->name; ?>',
            },
            // http: {
            //         emulateJSON: true,
            //         emulateHTTP: true
