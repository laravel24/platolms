...
@section('content')
    <div class="primary-content" id="page-content">
        <div class="">
            <h2 class="page-header mb30">Create College</h2>
        </div>
        ...
        <div class="content-box">          
            ...
            {!! Form::open(['route' => ['admin.colleges.store'], 'id' => 'form', 'method' => 'post', 'files' => 'true']) !!}
                ...
                {!! makeSelectField('contact_id', $admins, 'Contact To Display', '', '', 'required', $errors) !!}
