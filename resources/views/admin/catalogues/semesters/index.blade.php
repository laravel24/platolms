...
@section('content')
    <div class="primary-content" id="page-content">
        <h2 class="page-header mb30">All Semesters
            <span class="pull-right">
                <small>
                    <span style="margin-left:15px;font-size:70%;font-weight:700;">
                           <a href="{{ route('admin.semesters.archived') }}"><i class="fa fa-user"></i> &nbsp; Archived Semesters</a>
                    </span>
                    <span style="margin-left:15px;font-size:70%;font-weight:700;">
                            <a href="{{ route('admin.semesters.create') }}"><i class="fa fa-user"></i> &nbsp; New Semester</a>
                    </span>
                </small>
            </span>
        </h2>
                    ...
                    <table id="semesters-table" class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($semesters as $semester)
                                ...
                                <tr id="{{ $semester->id }}">
                                    <td>
                                        <a href="{{ route('admin.semesters.show', $semester->id) }}">{{ $semester->title }}</a>
                                    </td>
                                    <td class="text-right" style="padding-top: 15px;">
                                        <a href="{{ route('admin.semesters.show', $semester->id) }}" class="btn btn-success btn-sm"><i class="fa fa-globe"></i></a>
                                        <a href="{{ route('admin.semesters.edit', $semester->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i></a>
                                        <a class="btn btn-danger btn-sm" @click.prevent="confirmDelete({!! $semester->id !!}, $event)"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
