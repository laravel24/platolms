        ...
        <div class="sub-menu">
            <div class="row">
                ...
                <div class="{{ getColumns(6) }} text-right">
                    <h4 class="mb0 mt0">
                        <a href="{{ route('admin.categories.index') }}" class="btn btn-sm btn-info borderless @if (isset($menuTab) && ($menuTab == 'post-categories')) active @endif"><i class="fa fa-sitemap"></i> &nbsp; Post Categories</a>
